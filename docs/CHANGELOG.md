...
All notable changes to the LLM Gateway are documented here. This project follows
...
- `0003_multikey_monthly_meta` — adds `provider_credentials.meta`, the `api_keys`
  ...
  `alembic upgrade head` (or `llm-gateway db upgrade`).
